            ...
            items: [
                {
                    ...
                    context: "Atuação direta com dados operacionais e ERP em ambiente de produção, lidando com fontes inconsistentes e processos manuais.",
                    action: "Desenvolvi queries SQL e scripts de automação em Python para extrair, transformar e padronizar dados, reduzindo o trabalho manual e aumentando a confiabilidade para a tomada de decisão diária.",
                    learning: "Essa experiência moldou meu interesse pela confiabilidade dos dados e como decisões humanas dependem da qualidade dos sistemas subjacentes.",
                    stack: ["Python", "SQL Server", "Power BI", "Excel Intermediário", "AWS"],
                },
                {
                    company: "Sagrada Magia",
                    role: "Analista Administrativo",
                    period: "10/2021 - 09/2023",
                    description: "Análise de processos administrativos e controle operacional.",
                },
                {
                ...
                },
                {
                    ...
                    description: "Auxiliar nas rotinas administrativas da empresa.",
                },
            ]
        },
        education: {
            ...
            items: [
                {
                    ...
                    description: "Portfolio desenvolvido com Next.js, Tailwind e Framer Motion, focado em performance e design.",
            ...
            items: [
                {
                    ...
                    role: "IT Assistant",
                    period: "01/2024 - 01/2026",
                    context: "Worked with operational and ERP data in a production environment, dealing with inconsistent sources, manual processes, and recurring reporting needs.",
                    action: "Built SQL queries and Python automation scripts to extract, transform, and standardize data, reducing manual work and improving reliability for day-to-day decision making.",
                    learning: "This experience shaped my interest in data reliability, automation, and how human decisions depend on the quality of underlying systems.",
                    stack: ["Python", "SQL Server", "Power BI", "Intermediate Excel", "AWS"],
                },
                {
                    company: "Sagrada Magia",
                    role: "Administrative Analyst",
                    period: "10/2021 - 09/2023",
                    description: `Analysis of administrative processes and operational control.`,
                },
                {
                    company: "BRW Corporativo",
                    role: "Administrative Assistant",
                    period: "10/2018 - 09/2021",
                    description: `Administrative support and document organization.`,
                },
                {
                    company: "RETEC Residuos",
                    role: "Apprentice",
                    period: "07/2015 - 07/2016",
                    description: `Assisting in company administrative routines.`,
                },
            ]
        },
        education: {
            ...
            items: [
                {
                    ...
                    description: "Portfolio built with Next.js, Tailwind, and Framer Motion, focused on performance and design.",
                    tech: ["Next.js", "React", "Tailwind CSS"],
                    link: "#",
                },
                {
